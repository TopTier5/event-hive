                ...
                <div className="flex flex-row w-8/12 bg-gray-100 rounded-md mx-auto overflow-x-hidden">
                    <div className="w-1/2 bg-cover" style={{ backgroundImage: `url(${(register)})` }}>
                        <div className="flex flex-col text-white">
                            <h1 className="text-center mt-65 mb-6 text-2xl font-bold">Welcome back</h1>
                            <p className="text-xs text-center mb-8">To keep connected with us provide us with your information </p>
                            <button type="submit" className="block border border-[#B4B9C2] rounded text-white text-sm py-1 w-20 h-8 bg-[#B4B9C2] whitespace-nowrap ml-43 text-center">Sign In</button>
                        </div>
                    ...
                    <div className="w-1/2 py-16 px-12">
                        ...
                        <h2 className="text-center text-xl font-bold mt-5 mb-2 ml-10">Sign Up to Event Hive</h2>
                        <form action="#" className="">
                            <label className="block uppercase text-xs mb-2">Your Name</label>
                            <input type="text" placeholder="Enter your name" required className="border border-gray-100 rounded-md bg-white w-full text-gray-700 text-sm px-2 py-1 mb-6" />

                            <label className="blockn uppercase text-xs">Your Name</label>
                            <input type="text" placeholder="Enter your name" required className="border border-gray-100 rounded-md bg-white w-full text-gray-700 text-sm px-2 py-1 mt-2 mb-6" />
                            ...
                            <input type="password" placeholder="Enter your password" minlength="8" maxlength="16" pattern="^[a-zA-Z0-9_]*${16}" required className="border border-gray-100 rounded-md bg-white w-full text-gray-700 text-sm px-2 py-1" />
