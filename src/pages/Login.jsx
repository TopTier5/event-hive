                ...
                <div className="flex flex-row w-full bg-gray-100 rounded-md mx-auto overflow-x-hidden">
                    <div className="w-1/2 py-16 px-12">
                        ...
                        <form action="#" className="">
                            ...
                            <input type="email" placeholder="Enter your name" required className="border border-gray-100 rounded-md bg-white w-full text-gray-700 text-md px-4 py-2 mb-6" />
                            ...
                            <input type="password" required minlength="8" maxlength="16" pattern="^[a-zA-Z0-9_]*${16}" placeholder="Enter your password" className="border border-gray-100 rounded-md bg-white w-full text-gray-700 text-md px-4 py-2 mb-6" />


                            <button type="submit" className="border border-gray-100 rounded-md text-white text-md px-2 py-3 w-2/4 mt-6 ml-33 bg-[#7848F4]">Sign Up</button>
                    ...
                    <div className="w-1/2 bg-cover" style={{ backgroundImage: `url(${(login)})` }}>
                        <div className="flex flex-col text-white">
                            ...
                            <button type="submit" className="block border border-[#B4B9C2] rounded text-white text-md py-1 px-4 w-20 h-8 bg-[#B4B9C2] whitespace-nowrap ml-70">Sign Up</button>
                        </div>
